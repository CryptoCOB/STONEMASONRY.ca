      ...
      <div className="container-custom relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 px-2 md:px-0">
              ...
              >
                ...
                />
                <div>
                  <h3 className="font-heading font-semibold text-charcoal text-sm md:text-base group-hover:text-primaryRed transition-colors">Quality Materials</h3>
              ...
              >
                ...
                />
                <div>
                  <h3 className="font-heading font-semibold text-charcoal text-sm md:text-base group-hover:text-primaryRed transition-colors">Fully Insured</h3>
              ...
              >
                ...
                />
                <div>
                  <h3 className="font-heading font-semibold text-charcoal text-sm md:text-base group-hover:text-primaryRed transition-colors">Satisfaction Guarantee</h3>
          ...
          >
            ...
            >
              <img
                src="/images/about-us-stone-work.jpg"
        ...
        >
          ...
          >
            ...
            <div className="text-charcoal font-semibold text-sm md:text-base">Years Experience</div>
          </motion.div>
          ...
          >
            ...
            <div className="text-charcoal font-semibold text-sm md:text-base">Projects Completed</div>
          </motion.div>
          ...
          >
            ...
            <div className="text-charcoal font-semibold text-sm md:text-base">Satisfaction Rate</div>
          </motion.div>
          ...
          >
            ...
            <div className="text-charcoal font-semibold text-sm md:text-base">Support Available</div>
          </motion.div>
        </motion.div>
      </div>
    </section>
